...
public class LoadListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private void reflashViewByState() {
        ...
        ProgressBar header_pb = header.findViewById(R.id.header_pb);
        //设置的下拉箭头的动画效果
    ...
    public void reflashComplete() {
        ...
        reflashViewByState();
        //设置刷新完成的时间
        TextView lasetupdate_time = header.findViewById(R.id.tv_lastupdate_time);
