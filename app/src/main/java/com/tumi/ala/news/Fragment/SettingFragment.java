...
import com.tumi.ala.news.Activity.CoverActivity;
import com.tumi.ala.news.R;
import com.tumi.ala.news.Utils.ApplicationUtil;
import com.tumi.ala.news.Utils.FileCacheUtils;
...
public class SettingFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            break;
            case R.id.about_app: {
                Toast.makeText(getContext(), "@AlaNews ala.news.com version 1.0", Toast.LENGTH_SHORT).show();
            }
            break;
